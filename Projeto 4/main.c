...
void cria_grafo_vazio(TipoGrafo *Grafo) {
    int codigos[31] = {113476, 113034, 113468, 113042, 113450, 116319,
    113093, 116394, 117889, 115045, 113107, 113417, 116572, 117366,
    117897, 117901, 116343, 116378, 116441, 116653, 117935, 116882, 116416,
    116432, 117943, 117960, 117536, 117927, 117951, 116726, 117919};
    char nomes[31][42] = {"ALGORITMOS E PROGRAMACAO DE COMPUTADORES", "CALCULO 1", "INTRODUCAO AOS SISTEMAS COMPUTACIONAIS",
    "CALCULO 2", "FUNDAMENTOS TEORICOS DA COMPUTACAO", "ESTRUTURAS DE DADOS", "INTRODUCAO A ALGEBRA LINEAR", 
    ...
    "AUTOMATOS E COMPUTABILIDADE", "SISTEMAS DE INFORMACAO", "SOFTWARE BASICO", "COMPUTACAO EXPERIMENTAL", "FUNDAMENTOS DE SISTEMAS OPERACIONAIS",
    "PROJETO E ANALISE DE ALGORITMOS", "SEGURANCA COMPUTACIONAL", "COMPILADORES", "INFORMATICA E SOCIEDADE",
    "METODOLOGIA CIENTIFICA"};   
    int pesos[31] = {6, 6, 4, 6, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 6, 4, 4, 4, 4, 4, 4, 4, 2, 2};
